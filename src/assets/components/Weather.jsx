...
const Weather = ({ weatherInfo }) => {
  ...
  const resultTempConvertion = isCelsius
    ...
    <section className="text-center">
      ...
      <section className="grid gap-4 sm:grid-cols-[auto_auto]">
        ...
        <section className="bg-white/60 p-2 rounded-2xl grid grid-cols-2 items-center">
          <h4 className="col-span-2 mt-5 text-xl">
            {weatherInfo?.weather[0].description}
          </h4>
          <span className="text-5xl">
            {resultTempConvertion}°{isCelsius ? "C" : "F"}
          </span>
          <div>
            <img
      ...
      <button
        ...
        className="mt-4 bg-white rounded-full text-blue-500 px-5 py-1"
      >
